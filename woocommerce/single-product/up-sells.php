...
if ( $upsells ) : ?>
	...
	<section class="up-sells upsells products container <?php echo esc_attr($shop_col_class) ?>">  <!-- custom class 'container' and $shop_col_class added -->

		<h2><?php esc_html_e( 'You may also like&hellip;', 'seese' ) ?></h2>
